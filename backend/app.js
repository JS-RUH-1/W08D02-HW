...
const authorRouter = require('./rou/author')
const authorBook = require('./rou/books')
const authorRoutes =require('./rou/AuthRouter')
...
//Router
app.use('/app/author', authorRouter )
app.use('/app/book' ,authorBook  )
